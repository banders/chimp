...
public class ImproveCatchmentsOld {
	...
	private static final int MAX_SECTION_ITERATIONS = 30;
	...
	private static final int MIN_NO_IMPROVEMENT_COUNT_TO_SKIP_SECTION = 4;
	private static final int MIN_NO_IMPROVEMENT_COUNT_TO_SKIP_JUNCTION = 4;
	private static final int NUM_TESTS_PER_JUNCTION = 30; 
	private static final int MIN_TESTS_PER_SECTION = 10;
	private static final int MAX_TESTS_PER_SECTION = 100;
